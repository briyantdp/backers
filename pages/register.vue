<template>
  <div class="flex justify-center items-center">
    <div class="hidden md:block lg:w-1/3 bg-white auth-background rounded-tr-lg rounded-br-lg"></div>
...
<style scoped>
.auth-background {
  background-image: url("../static/images/sign-up/sign-up-background.jpg");
