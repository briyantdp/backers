<template>
  <div class="landing-page">
        ...
        <div class="flex items-center pt-10 px-5 md:px-0">
          <div class="w-1/2">
            <h1 class="text-4xl text-white mb-5">
              We helps
              <u class="hero-underline">startup</u> to
              <br />getting started &
              <u class="hero-underline">funding</u>
              <br />their truly needs
            </h1>
            <p class="text-white text-xl font-light mb-8">
              Fund the best idea to become
              <br />a real product and be the contributor
            </p>
            <button
          ...
          <div class="w-1/2 flex justify-center">
            <img src="../static/images/hero-images/hero-image@2x.png" alt="crowdfunding project" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="flex justify-between items-center mb-10">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            ...
            <br />your bright ideas
          </h2>
        </div>
      </div>
      <div class="flex">
        <div class="w-full px-56 mb-5">
          <img src="../static/svg/line-step.svg" alt class="w-full" />
        </div>
      </div>
      <div class="flex justify-between items-center text-center">
        <div class="w-1/3">
          <figure class="flex justify-center items-center">
            <img src="../static/svg/step-1-illustration.svg" alt class="h-30 mb-8" />
          </figure>
          <div class="step-content">
            <h3 class="font-medium">Sign Up</h3>
            <p class="font-light">
              Sign Up account and start
              <br />funding project
            </p>
          </div>
        </div>
        <div class="w-1/3">
          <figure class="flex justify-center items-center -mt-24">
            <img src="../static/svg/step-2-illustration.svg" alt class="h-30 mb-8" />
          </figure>
          <div class="step-content">
            <h3 class="font-medium">Open Project</h3>
            <p class="font-light">
              Choose some project idea,
              <br />and start funding
            </p>
          </div>
        </div>
        <div class="w-1/3">
          <figure class="flex justify-center items-center -mt-48">
            <img src="../static/svg/step-3-illustration.svg" alt class="h-30 mb-8" />
          </figure>
          <div class="step-content">
    ...
    <section class="container mx-auto pt-24">
      ...
      <div class="grid grid-cols-3 grid-rows-2 mt-3">
        <div class="card-project w-full p-5 border border-gray-500 rounded-20">
          <div class="item">
            <figure class="item-image">
              <img
                src="../static/images/project-thumbnail/project-thumbnail-1.jpg"
                alt
            ...
            <div class="item-meta">
              ...
              <p
                class="text-md font-light h-12 text-gray-900"
              >Creating robotic hand for better movement</p>
      ...
      <div class="flex mb-10">
        ...
        <div class="w-8/12 mt-16">
          ...
          <div class="testimonial-icon mt-10">
            <img
              src="../static/images/testimonial/testimonial-1-icon.png"
              alt
              class="w-20 mr-5 inline-block testimonial-user rounded-full"
            />
            <img
              src="../static/images/testimonial/testimonial-2-icon.png"
              alt
              class="w-20 mr-5 inline-block testimonial-user rounded-full"
            />
            <img
              src="../static/images/testimonial/testimonial-3-icon.png"
              alt
