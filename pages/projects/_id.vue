        ...
        <div class="w-3/4 mr-6">
          <div class="bg-white p-3 mb-3 border border-gray-400 rounded-20">
            <figure class="item-image">
              <img
                src="../../static/images/project-image/project-image.jpg"
                alt
          ...
          <div class="flex -mx-2">
            <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
              <figure class="item-thumbnail">
                <img
                  src="../../static/images/project-slider/project-slider-1.jpg"
                  alt
                  class="rounded-20 w-full"
                />
              </figure>
            ...
            <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
              <figure class="item-thumbnail">
                <img
                  src="../../static/images/project-slider/project-slider-2.jpg"
                  alt
                  class="rounded-20 w-full"
                />
              </figure>
            ...
            <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
              <figure class="item-thumbnail">
                <img
                  src="../../static/images/project-slider/project-slider-3.jpg"
                  alt
                  class="rounded-20 w-full"
                />
              </figure>
            ...
            <div class="relative w-1/4 bg-white m-2 p-2 border border-gray-400 rounded-20">
              <figure class="item-thumbnail">
                <img
                  src="../../static/images/project-slider/project-slider-4.jpg"
                  alt
                  class="rounded-20 w-full"
                />
              </figure>
