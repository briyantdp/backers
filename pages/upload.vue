      ...
      <div class="flex justify-center items-center mx-auto mb-4 w-40">
        <div class="relative">
          <nuxt-link to="/upload-filled">
            <img src="../static/avatars/avatar.jpg" alt class="rounded-full border-white border-4" />
            <img src="../static/svg/icon-avatar-add.svg" alt class="absolute right-0 bottom-0 pb-2" />
          </nuxt-link>
        </div>
      </div>
